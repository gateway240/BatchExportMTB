...
if __name__ == "__main__":
    export_multiple_sensors(
        trial_name="synthetic_trial01_tab", packet_count=120, delimiter="\t"
    )
    export_multiple_sensors(
        trial_name="synthetic_trial01_comma", packet_count=120, delimiter=","
    )
    export_multiple_sensors(
        trial_name="synthetic_trial01_space", packet_count=120, delimiter=" "
    )
